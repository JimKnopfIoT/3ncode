...
#include "src/folderlistmodel/fileinfothread_p.h"
...
void FileInfoThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FileInfoThread::directoryChanged)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FileInfoThread::directoryUpdated)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FileInfoThread::sortFinished)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject FileInfoThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_FileInfoThread.data,
      qt_meta_data_FileInfoThread,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FileInfoThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FileInfoThread.stringdata0))
        return static_cast<void*>(const_cast< FileInfoThread*>(this));
